  ...
  return [
    {
      ...
      stages: [
        ...
        },
        {
          id: createId(),
          name: "自由项目孵化",
          startDate: yearDate(currentYear, 7, 1),
          endDate: yearDate(currentYear + 1, 4, 30),
          color: "#d97706",
          description: "在主线工作之外，持续验证想长期投入的个人项目。",
          tags: ["项目", "试验"],
          excludedPeriods: [
            {
              id: createId(),
              name: "暂停迭代",
              startDate: yearDate(currentYear, 10, 1),
              endDate: yearDate(currentYear, 10, 10),
              reason: "给项目留出重新梳理方向的空档。",
              countAsExcluded: true,
              createdAt,
              updatedAt: createdAt,
            },
          ...
          milestones: [
            {
              id: createId(),
              name: "公开第一版",
              date: yearDate(currentYear, 9, 15),
              description: "第一次把项目放到真实环境里看反馈。",
              createdAt,
              updatedAt: createdAt,
            },
          ],
